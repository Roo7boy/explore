...
sleep 2
clear
toilet -f future "Pl4y BOy" | lolcat
sleep 2
clear
...
echo $b"============================================="
echo   "Team    : 'Team Adl'  Adholokam $white" |lolcat
echo   "Creadby  : Pl4y BoY(Dhilshad) $white" |lolcat
echo   "Contact  : Instagram.com/Dhilshad1 $white" |lolcat
echo   "YouTube : Expect Me
 $white" |lolcat
echo $b"============================================="
